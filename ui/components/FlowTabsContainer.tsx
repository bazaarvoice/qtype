...
const NO_FLOWS_FOUND_DESCRIPTION = 'No flows were found in the API specification. Make sure your FastAPI server has endpoints tagged with &quot;flow&quot; or paths starting with &quot;/flows/&quot;.'
...
function FlowTabsContainer() {
  ...
  if (isLoading) {
        return (
            <p className="text-muted-foreground text-sm">{LOADING_FLOWS}</p>
        )
    }
